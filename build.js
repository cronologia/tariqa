 ...
 * translation (fallback: English), and meta.language set to `lang`. Special
 * subtrees (SUBTREE_TRANSLATABLE) carry their own key allowlists — e.g.
 * `references` stays bibliographic except for `publisherNote`. With an
...
module.exports = {
  ...
  TRANSLATABLE_KEYS, SUBTREE_TRANSLATABLE, keysFor, UNKNOWN_REF_TYPES, renderReference,
