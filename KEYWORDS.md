...
`cronologia/archive` vault, or measured in this session (2026-07-25). Nothing
...
<!-- Generated by core/tools/build-keywords.py from tariqa/data/chronology.json (meta.lastUpdated 2026-07-20).
...
- `[[khalifa]]` · **Khalifa (Sufi usage)** · used 2× · variants: khalīfa, 'successor, deputy'; khilafat (the office conferred); cf. caliph · as written: `khalifas` · https://cronologia.github.io/glossary/khalifa/
- `[[muqaddam]]` · **Muqaddam** · used 3× · variants: an Arabic title also used for civil and military officials; in Sufism, the shaykh's authorized representative · https://cronologia.github.io/glossary/muqaddam/
...
- `[[tariqa]]` · **Tariqa (and the Maryamiyya)** · used 1× · https://cronologia.github.io/glossary/tariqa/
...
| dataset (all of the above) | - | 1877–2025 | meta.lastUpdated 2026-07-20 |
