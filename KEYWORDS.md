...
### 10. The corpus is incomplete — a zero can mean "not transcribed"
...
**Directly relevant to this repo:** none of the seven aulas mined for #30 or the
2012–2015 seam falls below 75%, so that work is unaffected. But `COF318` —
recorded as the highest-value *blocked* material on the order's internal life —
is `revisao_pendente` and undated, and its coverage is unknown for the same
reason its date is.

<!-- BEGIN GENERATED build-keywords.py -->
<!-- Generated by core/tools/build-keywords.py from tariqa/data/chronology.json (meta.lastUpdated 2026-07-30).
...
|---|---|---|---|
| events | 30 | 1912–2025 | 5 with dateVerified:false |
...
| dataset (all of the above) | - | 1877–2025 | meta.lastUpdated 2026-07-30 |
