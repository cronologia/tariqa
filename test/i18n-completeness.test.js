...
const PUBLISHER_BRACKET_OK = new Set([
  // "(EN)" / "(FR)" name the language EDITION of Wikipedia — the parenthetical
  // names which encyclopedia, it does not characterise it.
  'wikipedia-schuon', 'wikipedia-guenon', 'wikipedia-maryamiyya',
  'wikipedia-traditionalist-school', 'wikipedia-olavo', 'wikipedia-lings',
  'wikipedia-nasr', 'wikipedia-valsan', 'wikipedia-danner',
  'wikipedia-burckhardt', 'wikipedia-borella', 'wikipedia-perry',
  'wikipedia-worldwisdom', 'wikipedia-yellowtail', 'wikipedia-wolfgang-smith',
  'wikipedia-azevedo', 'wikipedia-ananda', 'wikipedia-pallis',
  'fr-wikipedia-borella',
  // "(Aarhus University)" NAMES the scholar's institution — it identifies who
  // the publisher is, it does not characterise the source.
  'sedgwick-blog',
  // "(Taylor & Francis)" NAMES the journal's parent publisher — an imprint.
  'tandfonline-bloomington',
]);
// <<< ADOPT
